...
class CreatePriceSubscription(Trading):
    ...
    def __init__(self, data):
        ...
        >>> data_from_mq = {_v3_CreatePriceSubscription_body}
...
@endpoint("openapi/trade/v1/prices/multileg", "POST", 201)
class GetMultilegPriceSubscription(Trading):
    ...
    def __init__(self, data):
        ...
        """
        super(GetMultilegPriceSubscription, self).__init__()
        self.data = data